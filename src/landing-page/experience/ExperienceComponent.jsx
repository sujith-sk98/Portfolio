  ...
  return (
    <div ref={titleRef} className={style.myExperienceScreen} id="my-experience">
      ...
      <div className={style.experienceDiv} ref={experience1Ref}>
        <motion.div
          className={style.experienceCardDiv}
          animate="animate"
              ...
              return (
                <motion.ul id={project.id} key={project.id}>
                  ...
                  {project.responsibilities.map(item => {
                    return <motion.li whileHover={{ x: 20 }}>{item}</motion.li>;
                  })}
                </motion.ul>
              );
            })}
        ...
        <div className={`${style.experienceTitle} ${style.belowTitle}`}>
          ...
          <motion.h2 style={{ scale: scale1, opacity: scale1 }}>
            2021 - 2022
          </motion.h2>
        </div>
      </div>
      ...
      <div className={style.experienceDiv} ref={experience2Ref}>
        <div className={style.experienceTitle}>
          ...
          <motion.h2 style={{ scale: scale2, opacity: scale2 }}>
            2022 - 2024
          </motion.h2>
        </div>
        <motion.div
      ...
      <div className={style.experienceDiv} ref={experience3Ref}>
        ...
        >
          <motion.div
            className={style.experienceCard}
            style={{ rotate: rotate3, scale: scale3 }}
          >
        ...
        <div className={`${style.experienceTitle} ${style.belowTitle}`}>
          ...
          <motion.h2 style={{ scale: scale3, opacity: scale3 }}>
            2024 - Present
          </motion.h2>
        </div>
      </div>
