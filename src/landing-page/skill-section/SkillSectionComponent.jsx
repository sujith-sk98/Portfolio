...
const SkillSectionComponent = () => {
    ...
    return (
        <div className={style.mySkillsScreen} id='my-skills' ref={skillsRef}>
            ...
            <SkillCarousal skills={frontEndSkillCards} title={'Front End Skills'}
                slideFrom={'right'} targetRef={skillsRef}
            />
            <SkillCarousal skills={backendSkillsCards} title={'Back End Skills'}
                slideFrom={'left'} targetRef={skillsRef}
            />
            <SkillCarousal skills={otherSkills} title={'Other Skills'}
                slideFrom={'right'} targetRef={skillsRef}
            />
        </div>
    )
